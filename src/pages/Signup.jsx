      ...
      <form>
        ...
        <div className="mt-8">
          ...
          <div className="relative flex items-center">
            ...
            {
              showPassword?
              <FaEye onClick={()=>setShowPassword(!showPassword)} className="w-[18px] h-[18px] absolute right-2 cursor-pointer"/>
              :
               <FaEyeSlash  onClick={()=>setShowPassword(!showPassword)} className="w-[18px] h-[18px] absolute right-2 cursor-pointer"/>
            }
